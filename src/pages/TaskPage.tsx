...
const TaskPage: React.FC = () => {
 ...
 if (loading) {
  return <div className="text-white text-center mt-10 sm:mt-20 text-sm sm:text-base">Loading tasks...</div>;
 }
 ...
 return (
  <div className="container mx-auto p-3 sm:p-4 lg:p-6 max-w-7xl">
   ...
   <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
    {tasks.length > 0 ? (
     tasks.map((task) => (
      <TaskCard
       key={task.id}
     ...
     <div className="col-span-full text-center py-8 sm:py-12">
      <p className="text-gray-400 text-sm sm:text-base">No tasks found.</p>
     </div>
    )}
   </div>
